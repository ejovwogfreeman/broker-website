        ...
        <div className="body investment withdraw">
          <div className='plan-box'>
            ...
            <div>
                ...
                <p className='last'><Link to='/bank-withdraw'>Withdraw Now</Link></p>
            </div>
          </div>    
          <div className='plan-box'>
            <h3>BITCOIN(BTC)</h3>
            <div>
                ...
                <p>Charge - 0 + 0% USD</p>
                <p>Processing Time - 1 Day</p>
                <p className='last'><Link to='/btc-withdraw'>Withdraw Now</Link></p>
            </div>
          </div>    
          <div className='plan-box'>
            <h3>LUNO</h3>
            <div>
                <img src={cryp4} alt="" width='100px'style={{margin: '20px'}}/>
                <p>Minimum - 2500.00 USD</p>
                <p>Maximum - 10000000.00 USD</p>
                <p>Charge - 0 + 0% USD</p>
                <p>Processing Time - 1 Day</p>
                <p className='last'><Link to='/luno-withdraw'>Withdraw Now</Link></p>
            </div>
          </div>    
          <div className='plan-box'>
            <h3>TETHER(USDT)</h3>
            <div>
                <img src={cryp2} alt="" width='100px'style={{margin: '20px'}}/>
                <p>Minimum - 1000.00 USD</p>
                <p>Maximum - 10000000.00 USD</p>
                <p>Charge - 0 + 0% USD</p>
                <p>Processing Time - 1 Day</p>
                <p className='last'><Link to='/tether-withdraw'>Withdraw Now</Link></p>
            </div>
          </div>    
         </div>        
      </div>
